...
<div class="container mt-5">
    <div class="card shadow">
        ...
        <div class="card-body">
            ...
            <p class="mb-4">Your booking has been successfully scheduled.
                Make Payment within 5 minutes or reservation will be revoked
            </p>
            ...
            <p class="text-muted">Thank you for booking with us! We look forward to serving you.
